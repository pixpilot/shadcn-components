    ...
    return (
            ...
            item: {
              actions: [
                ...
                },
                {
                  ...
                  onClick: ({ index }) => {
                    alert(`Info clicked for index ${index}`);
                  },
                },
              ],
            },
      ...
      >
        <div className="space-y-2">
          <h2 className="text-2xl font-bold">ArrayDialog (Header actions)</h2>
          <p className="text-muted-foreground">
            Custom icon buttons render in each item header and receive the current item
            field + index.
          </p>
        </div>

        <SchemaField>
          <SchemaField.Array name="contacts" x-component="ArrayDialog">
            <SchemaField.Object>
              <SchemaField.String
                name="name"
                title="Name"
...
export const WithMixedHeaderActions: Story = {
  render: () => {
    ...
    return (
      ...
      >
        <div className="space-y-2">
          <h2 className="text-2xl font-bold">ArrayDialog (Mixed header actions)</h2>
          <p className="text-muted-foreground">
